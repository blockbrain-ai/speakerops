...
| B07 | public | `/judge` | Open /judge role picker mints 4h demo session (no access code) | e2e/public/judge-access | Route 404 when switcher off; unseeded persona generic 401 | REQUIRED | PASS |
