# Spec 11.5 — Schedule Studio visual + interaction polish

> **Source Concept**: Polish ScheduleStudio presentation and conflict/pending states per design pack. | **Complexity**: high | **Risk**: high | **Domain**: frontend
...
- **Status**: Cumulative on dependencies ['11.0', '6.2', '10.6']
...
| Layer | Current State |
| --- | --- |
| Studio | apps/web/src/pages/schedule/ScheduleStudio.tsx |

## 2. Items In Scope

### Studio
- Full-height surface, sticky time/room, richer tiles, conflict summary
- Keyboard place/move remains
- Native HTML5 drag only (no new DnD package)
...
| Prior | 6.2 | Prior section complete |
...
| Conflict | Visible on tile + summary |
| Keyboard | Place without drag |
...
| --- | --- | --- | --- |
| Constitution souls mapped in phase index | 11.5 | Success metrics | Named tests above |
...
See Named ACs in this spec (or livability matrix for spo-11.5-lumen2-schedule-studio). Each AC maps to a named playwright/unit test file in plan Files-to-Create/Modify. Completion gate requires each AC ticked in plan.
