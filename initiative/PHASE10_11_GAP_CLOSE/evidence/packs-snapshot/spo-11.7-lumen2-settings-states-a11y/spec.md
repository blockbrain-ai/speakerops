# Spec 11.7 — Settings surfaces + global states + a11y

> **Source Concept**: Settings/DesignKit/ApiKeys polish + cross-cutting state components + a11y gates. | **Complexity**: high | **Risk**: high | **Domain**: frontend
...
- **Status**: Cumulative on dependencies ['11.1', '2.3', '2.4']
...
| Layer | Current State |
| --- | --- |
| Settings | EventSettings, DesignKit, Rubric, TaskTemplates, ApiKeys, Airtable |
| States | shared EmptyState/Alert patterns |

## 2. Items In Scope

### Settings
- Two-pane settings shell; Design Kit live public preview
### States
- Session expired recovery panel
- Network/empty/permission patterns
### A11y
- Focus traps, contrast, zoom, keyboard journeys per QA_CHECKLIST
...
| Prior | 2.3 | Prior section complete |
| Prior | 2.4 | Prior section complete |

## 5. Success Metrics

| Metric | Criteria |
| --- | --- |
| Session recovery | No auth alert inside shell |
| Settings IA | Two-pane |
| A11y | QA checklist section pass |
...
| --- | --- | --- | --- |
| Constitution souls mapped in phase index | 11.7 | Success metrics | Named tests above |
...
See Named ACs in this spec (or livability matrix for spo-11.7-lumen2-settings-states-a11y). Each AC maps to a named playwright/unit test file in plan Files-to-Create/Modify. Completion gate requires each AC ticked in plan.
