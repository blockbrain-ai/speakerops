# Spec 11.8 — Visual regression suite + taste score ≥8.0

> **Source Concept**: Screenshot suite for critical surfaces + documented taste score ≥8.0 / no primar | **Complexity**: high | **Risk**: medium | **Domain**: frontend
...
Screenshot suite for critical surfaces + documented taste score ≥8.0 / no primary &lt;7.0.

## Current Build Contract

- **Status**: Cumulative on dependencies ['11.2', '11.3', '11.4', '11.5', '11.6', '11.7']
...
| Layer | Current State |
| --- | --- |
| Audit | evidence/design-pack-snapshot/SPEAKEROPS_DESIGN_AUDIT.md scorecard |
| QA | design-pack/QA_CHECKLIST.md |

## 2. Items In Scope

### Visual suite
- Fixed viewport captures: state sheet, overview, CFP builder, public CFP, submissions bulk, schedule conflict, comms audience, portal, error states
### Score
- Independent rating doc LUMEN2_TASTE_SCORE.md
- Fail section if overall &lt;8.0 or primary &lt;7.0
...
| --- | --- | --- |
| Prior | 11.2 | Prior section complete |
| Prior | 11.3 | Prior section complete |
| Prior | 11.4 | Prior section complete |
| Prior | 11.5 | Prior section complete |
| Prior | 11.6 | Prior section complete |
| Prior | 11.7 | Prior section complete |

## 5. Success Metrics

| Metric | Criteria |
| --- | --- |
| Suite | Nine artifact classes captured |
| Score | ≥8.0 documented |
| Checklist | QA_CHECKLIST filled |

### Tests that prove these (E9)

- playwright visual or scripted screenshots
- score doc review
...
| --- | --- | --- | --- |
| Constitution souls mapped in phase index | 11.8 | Success metrics | Named tests above |
...
See Named ACs in this spec (or livability matrix for spo-11.8-lumen2-visual-score-gates). Each AC maps to a named playwright/unit test file in plan Files-to-Create/Modify. Completion gate requires each AC ticked in plan.
