# Spec 11.4 — Submissions + evaluations composition

> **Source Concept**: Recompose Submissions + AdminEvaluations/EvaluatorQueue with DataTable, toolbar, | **Complexity**: high | **Risk**: high | **Domain**: frontend
...
Recompose Submissions + AdminEvaluations/EvaluatorQueue with DataTable, toolbar, bulk bar.

## Current Build Contract

- **Status**: Cumulative on dependencies ['11.0', '10.1', '10.2']
...
| Layer | Current State |
| --- | --- |
| Submissions | apps/web/src/pages/Submissions.tsx |
| Eval | AdminEvaluations.tsx, EvaluatorQueue.tsx |

## 2. Items In Scope

### Submissions
- Toolbar, sticky bulk bar, filter chips, detail pane hierarchy
### Evaluations
- Coverage table, progress, low-distraction evaluator review
...
| Metric | Criteria |
| --- | --- |
| Bulk bar | Selection reveals actions |
| Detail | Hierarchy not raw dump |
| Eval | Progress readable |
...
| --- | --- | --- | --- |
| Constitution souls mapped in phase index | 11.4 | Success metrics | Named tests above |
...
See Named ACs in this spec (or livability matrix for spo-11.4-lumen2-submissions-evaluations). Each AC maps to a named playwright/unit test file in plan Files-to-Create/Modify. Completion gate requires each AC ticked in plan.
