# Spec 11.3 — CFP builder + public CFP Lumen 2

> **Source Concept**: Recompose FormBuilder + PublicCfp to Lumen 2 compositions without losing form lo | **Complexity**: high | **Risk**: high | **Domain**: frontend
...
- **Status**: Cumulative on dependencies ['11.0', '10.5', '3.2']
...
| Layer | Current State |
| --- | --- |
| Builder | apps/web/src/pages/FormBuilder.tsx |
| Public | apps/web/src/pages/PublicCfp.tsx |

## 2. Items In Scope

### Builder
- Outline + canvas + inspector; progressive advanced controls
### Public
- Branded intro, section progress, failure recovery, draft messaging from 10.5
...
| Prior | 3.2 | Prior section complete |

## 5. Success Metrics

| Metric | Criteria |
| --- | --- |
| Builder layout | Three regions desktop |
| Public | Branded + recovery |
| Parity | Publish/preview still works |

### Tests that prove these (E9)

- e2e form builder
- e2e public cfp visual states
...
| --- | --- | --- | --- |
| Constitution souls mapped in phase index | 11.3 | Success metrics | Named tests above |
...
See Named ACs in this spec (or livability matrix for spo-11.3-lumen2-cfp-builder-public). Each AC maps to a named playwright/unit test file in plan Files-to-Create/Modify. Completion gate requires each AC ticked in plan.
