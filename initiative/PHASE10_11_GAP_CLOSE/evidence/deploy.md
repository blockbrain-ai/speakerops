...
| **Timestamp (UTC)** | 2026-08-16T01:01:23Z |
| **Git SHA (short)** | `fe6e1d442` |
| **Git SHA (full)** | `fe6e1d44238623c0f532c0d8361fc62f19f67b6a` |
| **App version** | `0.1.0-demo+fe6e1d442` |
| **Worker name** | `speakerops-demo` |
| **Wrangler env** | `dogfood` |
| **Binding URL** | https://www.speakerops.org |
| **GET /health** | 200 |
| **Health body** | {"ok":true,"version":"0.1.0-demo+fe6e1d442"} |
...
Deploy revision: fe6e1d442 · APP_VERSION: 0.1.0-demo+fe6e1d442
Binding URL: https://www.speakerops.org
